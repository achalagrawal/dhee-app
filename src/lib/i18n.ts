...
const strings = {
  en: {
    ...
    modeDecisions: "A decision",
    modeRelationships: "A relationship",
    modePurpose: "Purpose",
    modeGrief: "Grief & loss",
    modeWork: "Work & meaning",
  ...
  hi: {
    ...
    modeDecisions: "एक फ़ैसला",
    modeRelationships: "एक रिश्ता",
    modePurpose: "उद्देश्य",
    modeGrief: "शोक और खोना",
    modeWork: "काम और अर्थ",
