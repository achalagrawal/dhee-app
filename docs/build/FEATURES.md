...
| Home topic modes + per-mode starter questions    | ✅     | `home.tsx`, `lib/starters.ts`         | 6 modes, each with 3 written starters, EN + HI. Shown only while the composer is empty; tapping one sends it. Chip toggles back to the default set |
